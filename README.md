...
Мне интересно организовать backend этого проекта в **микросервисной архитектуре**, а взаимодействие между микросервисами лермонтовизации текстов и микросервисом пользователей - в **событийной архитектуре**. Я хочу, чтобы этот проект имел образовательную ценность и продвигал лучшие практики разработки. Разумеется, рассчитываю в ходе выполнения проекта устранить собственные возможные недопонимания или заблуждения, касающиеся разработки backend приложений, и продемонстрировать свои навыки разработчика.
